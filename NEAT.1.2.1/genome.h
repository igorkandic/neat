...
namespace NEAT {
	...
	public:
		...
		static Genome *new_Genome_load(std::string filename);
		...
		void print_to_filename(std::string filename);
	...
	Genome *new_Genome_auto(int num_in,int num_out,int num_hidden,int type, const std::string filename);

	void print_Genome_tofile(Genome *g,const std::string filename);

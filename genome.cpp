...
Genome* Genome::new_Genome_load(std::string filename) {
	Genome *newgenome;

	int id;

	//char curline[1024];
	std::string curword;  //max word size of 20 characters
	//char delimiters[] = " \n";
	//int curwordnum = 0;
...
void Genome::print_to_filename(std::string filename) {
...
Genome* NEAT::new_Genome_auto(int num_in,int num_out,int num_hidden,int type, const std::string filename) {
...
void NEAT::print_Genome_tofile(Genome *g,const std::string filename) {
